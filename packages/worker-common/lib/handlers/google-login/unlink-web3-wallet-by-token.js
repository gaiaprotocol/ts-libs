...
export async function handleUnlinkGoogleWeb3WalletByToken(request, env, origin) {
    try {
        ...
        const result = await env.DB.prepare(`DELETE FROM google_web3_accounts
...
//# sourceMappingURL=unlink-web3-wallet-by-token.js.map