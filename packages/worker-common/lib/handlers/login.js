...
export async function handleLogin(request, chainId, env, domain, uri, messageForWalletLogin) {
    ...
    const valid = await validateSiwe(normalizedAddress, signature, chainId, env, domain, uri, messageForWalletLogin);
    if (!valid) {
